...
当前仅维护最新的 `0.2.x` 分支。发现漏洞时，请优先使用 GitHub 仓库的私有 Security Advisory
...
Windows 7 部署必须使用 SP1 并完整安装系统更新。`win7-compatible` Browser 包已经应用本地部署
v142 CRT 与 UCRT；SDK 或自行构建的程序仍需安装 KB2999226 和匹配的 v142 Redistributable。
